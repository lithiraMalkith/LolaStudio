...
export default function Footer() {
  return (
    <footer className="w-full py-xl px-gutter flex flex-col items-center gap-md bg-surface-container-lowest border-t border-outline-variant" id="footer">
      <div className="w-full max-w-container-max grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-xl mb-xl">
        ...
        <div className="flex flex-col gap-base">
          <p className="font-label-sm text-label-sm text-on-surface uppercase mb-xs opacity-60">Privacy Policy</p>
          <Link href="/privacy#collection" className="font-caption text-caption text-on-tertiary-container hover:text-primary">Data Collection</Link>
          <Link href="/privacy#usage" className="font-caption text-caption text-on-tertiary-container hover:text-primary">Data Usage</Link>
          <Link href="/privacy#rights" className="font-caption text-caption text-on-tertiary-container hover:text-primary">User Rights</Link>
        </div>
      </div>
      <div className="w-full flex flex-col md:flex-row justify-between items-center border-t border-outline-variant/30 pt-lg gap-md">
        <p className="font-caption text-caption text-on-tertiary-container uppercase tracking-[0.1em] opacity-100">© 2026 LOLA STUDIO. HANDMADE IN SRI LANKA.</p>
